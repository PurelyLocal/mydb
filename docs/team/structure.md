...
```mermaid
graph TD
    A[VP of Engineering] --> B[Director of Engineering]
    A --> C[Director of Platform]
    A --> D[Director of QA]
    
    B --> E[Engineering Manager - Frontend]
    B --> F[Engineering Manager - Backend]
    B --> G[Engineering Manager - Mobile]
